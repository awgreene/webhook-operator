...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "78ab7849.operators.coreos.io",
	})
	if err != nil {
	...
	if err = (&controllers.WebhookTestReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("WebhookTest"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "WebhookTest")
		os.Exit(1)
	}
	if err = (&webhookv1.WebhookTest{}).SetupWebhookWithManager(mgr); err != nil {
